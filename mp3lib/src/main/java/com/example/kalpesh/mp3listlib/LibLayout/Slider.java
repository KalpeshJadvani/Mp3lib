 ...
 */
package com.example.kalpesh.mp3listlib.LibLayout;
...
public class Slider extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(dpToPx(15, getResources()), dpToPx(15, getResources()));
